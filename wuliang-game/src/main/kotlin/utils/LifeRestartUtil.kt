...
import entity.vo.AgeDataVO
import entity.vo.EventDataVO
import entity.vo.JudgeItemVO
import entity.vo.TalentDataVo
import org.springframework.beans.factory.annotation.Autowired
import org.springframework.stereotype.Component
import respEnum.RestartRespEnum
import java.io.File
...
class LifeRestartUtil @Autowired constructor(
    ...
    fun findUserInfo(realId: String): UserInfoEntity? {
        ...
        return redisService.getValue("lifeRestart:userInfo:${realId}", UserInfoEntity::class.java)
    }
     ...
     * @return 事件内容
     */
    private fun doEvent(userInfo: UserInfoEntity, eventId: String, eventDataJson: JsonNode): List<SendListEntity> {
     ...
     * @param userInfo 用户信息
     */
    fun next(userInfo: UserInfoEntity, ageData: JsonNode, eventData: JsonNode): List<SendListEntity> {
        ageNext(userInfo)
     ...
     * @return 事件内容
     */
    fun trajectory(userInfo: UserInfoEntity, ageData: JsonNode, eventData: JsonNode): List<SendListEntity> {
     ...
     * @return 天赋列表
     */
    private fun talentRandom(include: TalentDataVo?, userInfo: UserInfoEntity): MutableList<TalentDataVo> {

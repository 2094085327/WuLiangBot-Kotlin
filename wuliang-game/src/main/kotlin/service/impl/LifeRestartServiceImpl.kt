...
import entity.LifeRestartEntity
import mapper.LifeRestartMapper
 ...
 */
@Service
class LifeRestartServiceImpl : ServiceImpl<LifeRestartMapper?, LifeRestartEntity?>(), LifeRestartService {
    @Autowired
    ...
    override fun insertTimesByRealId(realId: String) {
        ...
        if (existRestartInfo == null) restartMapper.insert(restartInfo)
            ...
            val restartInfoUpdate = LifeRestartEntity(realId = realId, times = existRestartInfo.times?.plus(1))
